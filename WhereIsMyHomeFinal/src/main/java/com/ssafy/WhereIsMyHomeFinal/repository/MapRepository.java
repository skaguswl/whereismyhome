...
public interface MapRepository extends JpaRepository<Dongcode, Long> {
    ...
    @Query("select new com.ssafy.WhereIsMyHomeFinal.domain.dto.MapDto(substring(d.dongCode, 1, 4), d.gugunName) from Dongcode d where d.dongCode like concat(:regcodePattern,'__000000')")
