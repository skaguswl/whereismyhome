...
public interface HouseinfoRepository extends JpaRepository<Houseinfo, Long> {
    ...
    @Query("select new com.ssafy.WhereIsMyHomeFinal.domain.dto.AptDto(h.aptCode, h.buildYear, h.roadName, h.dong, h.jibun, h.apartmentName, hd.dealAmount, h.lat, h.lng, hd.area, hd.floor, hd.dealYear, hd.dealMonth, hd.dealDay)" +
